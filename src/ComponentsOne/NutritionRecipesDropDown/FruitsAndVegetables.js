...
function FruitsAndVegetables() {
  return (
    <div className='hlt-container'>
      <h1>Affordable Fruits and Vegetables in Nigeria</h1>
  ...
  <ul>
    ...
    <li>
      ...
      <section>
        ...
        <p>These fruits and vegetables from other countries are also available in Nigerian supermarkets and local markets:</p>
        <ul>
          <li>
            <strong>Apples:</strong> Imported but often available in larger Nigerian supermarkets, apples are crunchy, juicy, and great for snacking.
            <br />
            <strong>Benefits:</strong> Rich in fiber and vitamin C. Helps improve digestion and boosts immunity.
          </li>
          <li>
            <strong>Strawberries:</strong> Though a bit more expensive, strawberries are available in major cities and add a sweet, tangy flavor to smoothies and desserts.
            <br />
            <strong>Benefits:</strong> High in antioxidants and vitamin C, which helps with skin health and boosts the immune system.
          </li>
          <li>
            <strong>Kiwi:</strong> Although not locally grown, kiwis can be found in larger grocery stores. They are packed with nutrients and add a unique tart flavor.
            <br />
            <strong>Benefits:</strong> Rich in vitamins C and E, supports the immune system, and promotes healthy skin.
          </li>
          <li>
          ...
          <li>
            ...
            <br />
            <strong>Benefits:</strong> Rich in healthy fats, vitamins E and C, and potassium. Supports heart health and promotes glowing skin.
          </li>
        </ul>
      </section>

      <section>
        <h2>3. How to Include Fruits and Vegetables in Your Diet</h2>
        <p>Here are some simple ways to incorporate more fruits and vegetables into your daily meals:</p>
        <ul>
          <li>
            <strong>Smoothies:</strong> Add a combination of local and international fruits like pawpaw, banana, avocado, and apples for a nutrient-packed smoothie.
          </li>
          <li>
            <strong>Salads:</strong> Combine cucumbers, tomatoes, and carrots with leafy greens for a refreshing, low-calorie salad.
          </li>
          <li>
            <strong>Juices:</strong> Make fresh juices from fruits like watermelon, pineapple, and oranges for a hydrating and vitamin-rich drink.
          </li>
          <li>
            <strong>Stews & Soups:</strong> Incorporate vegetables like carrots, spinach, and tomatoes into your stews and soups for added nutrients.
          </li>
          <li>
            <strong>Snacks:</strong> Keep fruits like apples, bananas, and oranges as on-the-go snacks. They’re easy to carry and packed with energy-boosting nutrients.
          </li>
        </ul>
      </section>

      <section>
        <h2>4. Benefits of Eating More Fruits and Vegetables</h2>
        <ul>
          <li><strong>Improved Digestion:</strong> High fiber content in fruits and vegetables helps regulate digestion and promotes a healthy gut.</li>
          <li><strong>Boosted Immunity:</strong> Fruits like oranges, pawpaw, and tomatoes are rich in vitamins C and antioxidants, which strengthen your immune system.</li>
          <li><strong>Skin Health:</strong> Many fruits and vegetables, like avocado, carrots, and strawberries, are packed with vitamins that promote healthy skin.</li>
          <li><strong>Weight Management:</strong> Fruits and vegetables are low in calories but high in nutrients, making them perfect for maintaining a healthy weight.</li>
          <li><strong>Increased Energy:</strong> The natural sugars in fruits and the fiber in vegetables provide sustained energy throughout the day.</li>
        </ul>
      </section>

      <footer className='hlt-footer'>
        <p>Explore NutriLife Path for more affordable healthy meal plans, recipes, and tips that suit every Nigerian. Start your journey to a healthier lifestyle today!</p>
      </footer>
    </div>
  );
}
